...
//! \file adiabatic_mhd.hpp
//  \brief implements functions in class EquationOfState for adiabatic magnetohydrodynamics
...
class AdiabaticMHDEOS : public EquationOfState {
 public:
  AdiabaticMHDEOS(Real pressure_floor, Real density_floor, Real internal_e_floor,
