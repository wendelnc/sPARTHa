...
#ifndef HYDRO_WENO9_HPP_
#define HYDRO_WENO9_HPP_
...
template <>
struct Reconstruct<Fluid::euler, Reconstruction::weno9> {
  ...
  Solve(parthenon::team_mbr_t const &member, const int k, const int j, const int il,
    ...
    parthenon::par_for_inner(member, il, iu, [&](const int i) {
      ...
      Real q0[(NHYDRO)], q1[(NHYDRO)], q2[(NHYDRO)], q3[(NHYDRO)], q4[(NHYDRO)], q5[(NHYDRO)], q6[(NHYDRO)], q7[(NHYDRO)], q8[(NHYDRO)], q9[(NHYDRO)];
      Real f0[(NHYDRO)], f1[(NHYDRO)], f2[(NHYDRO)], f3[(NHYDRO)], f4[(NHYDRO)], f5[(NHYDRO)], f6[(NHYDRO)], f7[(NHYDRO)], f8[(NHYDRO)], f9[(NHYDRO)];
      Real eigenvalues[(NHYDRO)], right_eigenmatrix[(NHYDRO)][(NHYDRO)], left_eigenmatrix[(NHYDRO)][(NHYDRO)];
      Real vj0[NHYDRO], vj1[NHYDRO], vj2[NHYDRO], vj3[NHYDRO], vj4[NHYDRO], vj5[NHYDRO], vj6[NHYDRO], vj7[NHYDRO], vj8[NHYDRO], vj9[NHYDRO];
      Real gj0[NHYDRO], gj1[NHYDRO], gj2[NHYDRO], gj3[NHYDRO], gj4[NHYDRO], gj5[NHYDRO], gj6[NHYDRO], gj7[NHYDRO], gj8[NHYDRO], gj9[NHYDRO];
      Real g_p0[NHYDRO], g_p1[NHYDRO], g_p2[NHYDRO], g_p3[NHYDRO], g_p4[NHYDRO], g_p5[NHYDRO], g_p6[NHYDRO], g_p7[NHYDRO], g_p8[NHYDRO], g_p9[NHYDRO];
      Real g_m0[NHYDRO], g_m1[NHYDRO], g_m2[NHYDRO], g_m3[NHYDRO], g_m4[NHYDRO], g_m5[NHYDRO], g_m6[NHYDRO], g_m7[NHYDRO], g_m8[NHYDRO], g_m9[NHYDRO];
      ...
      Real pre8 = (gm1) * (q8[IEN] - 0.5*q8[IDN]*vnm8);

      f8[IDN] = q8[IM1];
      f8[IM1] = q8[IM1] * vex8 + pre8;
      f8[IM2] = q8[IM1] * vey8;
      f8[IM3] = q8[IM1] * vez8;
      f8[IEN] = vex8 * (q8[IEN] + pre8);
      ...
      Real pre9 = (gm1) * (q9[IEN] - 0.5*q9[IDN]*vnm9);

      f9[IDN] = q9[IM1];
      f9[IM1] = q9[IM1] * vex9 + pre9;
      f9[IM2] = q9[IM1] * vey9;
      f9[IM3] = q9[IM1] * vez9;
      f9[IEN] = vex9 * (q9[IEN] + pre9);
      ...
      for (int ii = 0; ii < NHYDRO; ++ii) {
        ...
        for (int jj = 0; jj < NHYDRO; ++jj) {
          ...
          vj8[ii] += left_eigenmatrix[ii][jj] * q8[jj];
          vj9[ii] += left_eigenmatrix[ii][jj] * q9[jj];
          ...
          gj8[ii] += left_eigenmatrix[ii][jj] * f8[jj];
          gj9[ii] += left_eigenmatrix[ii][jj] * f9[jj];
      ...
      Real a8 = std::sqrt((gamma * pre8) / q8[IDN]);
      Real a9 = std::sqrt((gamma * pre9) / q9[IDN]);

      Real max_eig_0 = std::max({std::abs(vex0-a0), std::abs(vex1-a1), std::abs(vex2-a2), std::abs(vex3-a3), std::abs(vex4-a4), std::abs(vex5-a5), std::abs(vex6-a6), std::abs(vex7-a7), std::abs(vex8-a8), std::abs(vex9-a9)});
      Real max_eig_1 = std::max({std::abs(vex0),    std::abs(vex1),    std::abs(vex2),    std::abs(vex3),    std::abs(vex4),    std::abs(vex5),    std::abs(vex6),    std::abs(vex7),    std::abs(vex8),    std::abs(vex9)});
      Real max_eig_2 = std::max({std::abs(vex0+a0), std::abs(vex1+a1), std::abs(vex2+a2), std::abs(vex3+a3), std::abs(vex4+a4), std::abs(vex5+a5), std::abs(vex6+a6), std::abs(vex7+a7), std::abs(vex8+a8), std::abs(vex9+a9)});
