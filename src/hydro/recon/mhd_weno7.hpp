...
#ifndef MHD_WENO7_HPP_
#define MHD_WENO7_HPP_
...
template <>
struct Reconstruct<Fluid::mhd, Reconstruction::weno7> {
  ...
  Solve(parthenon::team_mbr_t const &member, const int k, const int j, const int il,
    ...
    parthenon::par_for_inner(member, il, iu, [&](const int i) {
      ...
      Real q0[(NMHD)], q1[(NMHD)], q2[(NMHD)], q3[(NMHD)], q4[(NMHD)], q5[(NMHD)], q6[(NMHD)], q7[(NMHD)];
      Real f0[(NMHD)], f1[(NMHD)], f2[(NMHD)], f3[(NMHD)], f4[(NMHD)], f5[(NMHD)], f6[(NMHD)], f7[(NMHD)];
      Real rr[(NMHD)][(NMHD)], ru[(NMHD)][(NMHD)], lu[(NMHD)][(NMHD)], lq[(NMHD)][(NMHD)];
      Real vj0[NMHD], vj1[NMHD], vj2[NMHD], vj3[NMHD], vj4[NMHD], vj5[NMHD], vj6[(NMHD)], vj7[(NMHD)];
      Real gj0[NMHD], gj1[NMHD], gj2[NMHD], gj3[NMHD], gj4[NMHD], gj5[NMHD], gj6[(NMHD)], gj7[(NMHD)];
      Real g_p0[NMHD], g_p1[NMHD], g_p2[NMHD], g_p3[NMHD], g_p4[NMHD], g_p5[NMHD], g_p6[(NMHD)], g_p7[(NMHD)];
      Real g_m0[NMHD], g_m1[NMHD], g_m2[NMHD], g_m3[NMHD], g_m4[NMHD], g_m5[NMHD], g_m6[(NMHD)], g_m7[(NMHD)];
      Real weno_sum[NMHD];
      Real f_half[NMHD];
      ...
      if (ivx == IV1){
        ...
        q0[IB1] = cons(iBx, k, j, i - 4);
        q0[IB2] = cons(iBy, k, j, i - 4);
        q0[IB3] = cons(iBz, k, j, i - 4);
        ...
        q1[IB1] = cons(iBx, k, j, i - 3);
        q1[IB2] = cons(iBy, k, j, i - 3);
        q1[IB3] = cons(iBz, k, j, i - 3);
        ...
        q2[IB1] = cons(iBx, k, j, i - 2);
        q2[IB2] = cons(iBy, k, j, i - 2);
        q2[IB3] = cons(iBz, k, j, i - 2);
        ...
        q3[IB1] = cons(iBx, k, j, i - 1);
        q3[IB2] = cons(iBy, k, j, i - 1);
        q3[IB3] = cons(iBz, k, j, i - 1);
        ...
        q4[IB1] = cons(iBx, k, j, i);
        q4[IB2] = cons(iBy, k, j, i);
        q4[IB3] = cons(iBz, k, j, i);
        ...
        q5[IB1] = cons(iBx, k, j, i + 1);
        q5[IB2] = cons(iBy, k, j, i + 1);
        q5[IB3] = cons(iBz, k, j, i + 1);       
        ...
        q6[IB1] = cons(iBx, k, j, i + 2);
        q6[IB2] = cons(iBy, k, j, i + 2);
        q6[IB3] = cons(iBz, k, j, i + 2);
        ...
        q7[IB1] = cons(iBx, k, j, i + 3);
        q7[IB2] = cons(iBy, k, j, i + 3);
        q7[IB3] = cons(iBz, k, j, i + 3);
      }
      ...
      if (ivx == IV2){
        ...
        q0[IB1] = cons(iBx, k, j - 4, i);
        q0[IB2] = cons(iBy, k, j - 4, i);
        q0[IB3] = cons(iBz, k, j - 4, i);
        ...
        q1[IB1] = cons(iBx, k, j - 3, i);
        q1[IB2] = cons(iBy, k, j - 3, i);
        q1[IB3] = cons(iBz, k, j - 3, i); 
        ...
        q2[IB1] = cons(iBx, k, j - 2, i);
        q2[IB2] = cons(iBy, k, j - 2, i);
        q2[IB3] = cons(iBz, k, j - 2, i);
        ...
        q3[IB1] = cons(iBx, k, j - 1, i);
        q3[IB2] = cons(iBy, k, j - 1, i);
        q3[IB3] = cons(iBz, k, j - 1, i);
        ...
        q5[IB1] = cons(iBx, k, j + 1, i);
        q5[IB2] = cons(iBy, k, j + 1, i);
        q5[IB3] = cons(iBz, k, j + 1, i);
        ...
        q6[IB1] = cons(iBx, k, j + 2, i);
        q6[IB2] = cons(iBy, k, j + 2, i);
        q6[IB3] = cons(iBz, k, j + 2, i);
        ...
        q7[IB1] = cons(iBx, k, j + 3, i);
        q7[IB2] = cons(iBy, k, j + 3, i);
        q7[IB3] = cons(iBz, k, j + 3, i);
      }
      ...
      if (ivx == IV3){
        ...
        q0[IB1] = cons(iBx, k - 4, j, i);
        q0[IB2] = cons(iBy, k - 4, j, i);
        q0[IB3] = cons(iBz, k - 4, j, i);
        ...
        q1[IB1] = cons(iBx, k - 3, j, i);
        q1[IB2] = cons(iBy, k - 3, j, i);
        q1[IB3] = cons(iBz, k - 3, j, i);
        ...
        q2[IB1] = cons(iBx, k - 2, j, i);
        q2[IB2] = cons(iBy, k - 2, j, i);
        q2[IB3] = cons(iBz, k - 2, j, i);
        ...
        q3[IB1] = cons(iBx, k - 1, j, i);
        q3[IB2] = cons(iBy, k - 1, j, i);
        q3[IB3] = cons(iBz, k - 1, j, i);
        ...
        q5[IB1] = cons(iBx, k + 1, j, i);
        q5[IB2] = cons(iBy, k + 1, j, i);
        q5[IB3] = cons(iBz, k + 1, j, i);
        ...
        q6[IB1] = cons(iBx, k + 2, j, i);
        q6[IB2] = cons(iBy, k + 2, j, i);
        q6[IB3] = cons(iBz, k + 2, j, i);
        ...
        q7[IB1] = cons(iBx, k + 3, j, i);
        q7[IB2] = cons(iBy, k + 3, j, i);
        q7[IB3] = cons(iBz, k + 3, j, i);
      }
      ...
      Real half_Bx  = 0.5 * (q3[IB1] + q4[IB1]);
      Real half_By  = 0.5 * (q3[IB2] + q4[IB2]);
      Real half_Bz  = 0.5 * (q3[IB3] + q4[IB3]);
      ...
      Real max_eig_1 = std::max({em, std::abs(vex0),      std::abs(vex1),      std::abs(vex2),      std::abs(vex3),      std::abs(vex4),      std::abs(vex5),      std::abs(vex6),      std::abs(vex7)});
      Real max_eig_2 = std::max({em, std::abs(vex0),      std::abs(vex1),      std::abs(vex2),      std::abs(vex3),      std::abs(vex4),      std::abs(vex5),      std::abs(vex6),      std::abs(vex7)});
      Real max_eig_3 = std::max({em, std::abs(vex0+cax0), std::abs(vex1+cax1), std::abs(vex2+cax2), std::abs(vex3+cax3), std::abs(vex4+cax4), std::abs(vex5+cax5), std::abs(vex6+cax6), std::abs(vex7+cax7)});
      Real max_eig_4 = std::max({em, std::abs(vex0-cax0), std::abs(vex1-cax1), std::abs(vex2-cax2), std::abs(vex3-cax3), std::abs(vex4-cax4), std::abs(vex5-cax5), std::abs(vex6-cax6), std::abs(vex7-cax7)});
      Real max_eig_5 = std::max({em, std::abs(vex0+cfx0), std::abs(vex1+cfx1), std::abs(vex2+cfx2), std::abs(vex3+cfx3), std::abs(vex4+cfx4), std::abs(vex5+cfx5), std::abs(vex6+cfx6), std::abs(vex7+cfx7)});
      Real max_eig_6 = std::max({em, std::abs(vex0-cfx0), std::abs(vex1-cfx1), std::abs(vex2-cfx2), std::abs(vex3-cfx3), std::abs(vex4-cfx4), std::abs(vex5-cfx5), std::abs(vex6-cfx6), std::abs(vex7-cfx7)});
      Real max_eig_7 = std::max({em, std::abs(vex0+csx0), std::abs(vex1+csx1), std::abs(vex2+csx2), std::abs(vex3+csx3), std::abs(vex4+csx4), std::abs(vex5+csx5), std::abs(vex6+csx6), std::abs(vex7+csx7)});
      Real max_eig_8 = std::max({em, std::abs(vex0-csx0), std::abs(vex1-csx1), std::abs(vex2-csx2), std::abs(vex3-csx3), std::abs(vex4-csx4), std::abs(vex5-csx5), std::abs(vex6-csx6), std::abs(vex7-csx7)});
